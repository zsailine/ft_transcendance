		...
		<div className=" w-full flex justify-center px-8">
			<div className="w-full  text-gray-100 rounded-xl shadow-lg px-6 sm:px-10 py-8">
				...
				<div className="space-y-6 text-sm sm:text-base leading-relaxed text-gray-100">
					...
					Game data (scores, rankings, gameplay statistics)

					Technical data (IP address, browser type, device information)

					We do not intentionally collect sensitive personal data.

					<h2 className="font-bold mb-0 mt-4">3. How We Use Information</h2>
					...
					We take reasonable measures to protect user data from unauthorized access, loss, or misuse.
					However, no online service can be 100% secure.

					<h2 className="font-bold mb-0 mt-4">6. Cookies</h2>

					The Platform may use basic cookies or local storage for:
					...
					You may request access to or deletion of your data by contacting the Platform operator.

					<h2 className="font-bold mb-0 mt-4">9. Changes to This Policy</h2>

import QuitTournament from './quitTournament';
...
export default function WaitingPlayer({ tournament }: { tournament: TournamentInterface}) {
    ...
    const disabled = tournament.maxPlayers !== tournament.currentPlayers;
    ...
    return (
        <div className="p-5 flex-row">
            ...
            <div className="flex justify-center mt-6">
                <QuitTournament />
                {playersList[0][0] === username && <StartTournament disabled={disabled} />}
            </div>
        </div>
    )
}